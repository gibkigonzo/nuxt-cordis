...
<template>
  <main class="shell">
    <p class="badge">modul @shop/module-cart &middot; inject: cart</p>
    <div class="top">
      <h1>Koszyk</h1>
      <NuxtLink class="ghost" to="/product">&larr; Wroc do katalogu</NuxtLink>
    </div>
    ...
    <section v-if="cart && cart.items.length" class="list">
      ...
      <div class="actions">
        ...
        <NuxtLink class="primary" to="/checkout">Przejdz do platnosci &rarr;</NuxtLink>
      </div>
    </section>

    <section v-else class="empty">
      <p>Koszyk jest pusty.</p>
      <NuxtLink class="primary" to="/product">Zobacz katalog produktow</NuxtLink>
    </section>

    <p class="hint">
      Ta strona odpytuje ten sam koefekt <code>ctx.get('cart')</code>, do ktorego pisze
      modul <code>@shop/module-product</code> - inny modul Nuxta, ten sam
      obiekt w pamieci procesu.
    </p>
  </main>
</template>
