...
// z kodu klienckiego Nuxta (wylacznie typy ponizej - czyste dane, zero logiki),
// a "server-only" funkcje (dostep do zywego ctx Cordis, wyliczanie per-request
// cart-id) wymagaja jawnego importu z podsciezki ("@shop/shared/bridge",
