...
<template>
  <main class="shell">
    <p class="badge">apps/product &middot; port 3001 &middot; inject: cart, product</p>
    <div class="top">
      <h1>Katalog produktow</h1>
      <a class="ghost" href="/cart">Przejdz do koszyka &rarr;</a>
    </div>
    ...
    <p class="hint">
      ...
      pamieci procesu orchestratora, nie requestami HTTP do innej instancji.
    </p>
  </main>
</template>
...
.shell { max-width: 960px; margin: 0 auto; padding: 3rem 1.5rem 5rem; }
.badge {
...
.hint { color: #9c8fc4; font-size: .82rem; border-top: 1px solid rgba(255,255,255,.08); padding-top: 1.5rem; }
